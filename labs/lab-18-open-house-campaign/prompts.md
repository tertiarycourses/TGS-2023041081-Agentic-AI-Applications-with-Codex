# Prompts — Lab 18: Lead Magnet, Newsletter and the Open-House Campaign

Surface: Codex (skills.sh) → ChatGPT Work (@Gmail, analysis). Paste each prompt as written; change only what the lab tells you to.
