# Prompts — Lab 16: Marketing Know-how as Skills, Then the Flyer

Surface: Chat → Codex ($skill-creator, $imagegen). Paste each prompt as written; change only what the lab tells you to.
