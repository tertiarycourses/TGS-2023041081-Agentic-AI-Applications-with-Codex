# Prompts — Lab 04: Publish the Site: GitHub Pages and Sites

Surface: Codex → GitHub Pages → @Sites. Paste each prompt as written; change only what the lab tells you to.
